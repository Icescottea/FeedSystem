    ...
    try {
      ...
      const mockData = [
        ...
        },
        {
          ...
          payment: 'UNPAID',
          amount: 180000,
          expectedShipmentDate: '2024-12-28',
          orderStatus: 'PENDING',
        ...
        },
        {
          ...
          referenceNumber: 'REF-SO-003',
          date: '2024-12-15',
          customerName: 'Royal Livestock Co.',
          status: 'CONFIRMED',
          invoiced: 'FULLY_INVOICED',
          payment: 'PAID',
          amount: 320000,
          expectedShipmentDate: '2024-12-20',
          orderStatus: 'SHIPPED',
        ...
        },
        {
          ...
          payment: 'UNPAID',
          amount: 150000,
          expectedShipmentDate: '2024-12-15',
